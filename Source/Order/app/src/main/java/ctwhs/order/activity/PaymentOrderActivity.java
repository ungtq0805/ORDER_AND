...
import ctwhs.order.adapter.PaymentOrderAdapter;
...
public class PaymentOrderActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    listview.setAdapter(new PaymentOrderAdapter(this, order));
	}
	...
	protected void onStart()
	{
	    ...
	    text.setText("Cost: "+ ConvertUtils.getDecimal(order.totalPrice));
